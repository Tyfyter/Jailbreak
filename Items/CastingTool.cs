...
namespace Jailbreak.Items {
    ...
    public class ModularCastingTool : CastingTool {
        ...
        public float recharge {
            get {
                ...
                switch(powerCellItem.Value.type) {
                    ...
                    return PowerCellGlobalItem.LihzahrdRecharge;
        ...
        public override void RightClick(Player player) {
            ...
            Jailbreak.instance.modularUIState.SafeAddItemSlot(ref powerCellItem, ValidItemFunc:(i)=>i.IsAir||PowerCellGlobalItem.maxCharge(i)>0);
        }
